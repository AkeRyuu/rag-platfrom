...
import {
  fetchCollections, fetchCollectionInfo, fetchAliases, fetchIndexStatus,
  triggerReindex, clearCollectionApi, deleteCollectionApi,
  createSnapshotApi, listSnapshotsApi, fetchCollectionAnalytics, fetchClusterHealth,
} from '@/api/collections'
import type { CollectionSummary, CollectionInfo, AliasInfo, IndexStatus, Snapshot, CollectionAnalytics, ClusterHealth } from '@/types/collections'
...
export const useCollectionsStore = defineStore('collections', () => {
  ...
  async function clearCollection() {
    ...
    selectedCollection.value = await fetchCollectionInfo(selectedCollection.value.name)
  }
  ...
  return {
    collections, selectedCollection, aliases, loading, error,
    indexStatus, analytics, snapshots, clusterHealth,
    loadCollections, selectCollection, clearSelection,
    reindexCollection, clearCollection, deleteCollection, createSnapshot,
  }
})
