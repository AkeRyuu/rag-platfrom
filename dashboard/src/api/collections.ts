...
import type { CollectionSummary, CollectionInfo, IndexStatus, AliasInfo, Snapshot, CollectionAnalytics, ClusterHealth } from '@/types/collections'
...
export async function fetchCollectionAnalytics(name: string): Promise<CollectionAnalytics> {
