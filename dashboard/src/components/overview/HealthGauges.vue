    ...
    <Card>
      <template #content>
        <div style="text-align: center;">
          ...
          <div style="color: var(--p-text-muted-color); margin-top: 0.25rem;">Total Calls</div>
        </div>
      </template>
    </Card>
    <Card>
      <template #content>
        <div style="text-align: center;">
          ...
          />
          <div style="color: var(--p-text-muted-color); margin-top: 0.25rem;">Success Rate</div>
        </div>
      </template>
    </Card>
    <Card>
      <template #content>
        <div style="text-align: center;">
          ...
          <div style="color: var(--p-text-muted-color); margin-top: 0.25rem;">Avg Latency (ms)</div>
        </div>
      </template>
    </Card>
  </div>
