 ...
 */
export function createAdvancedTools(projectName: string): ToolModule {
  const tools = [
    {
      name: "merge_memories",
      ...
      inputSchema: {
        ...
        properties: {
          typeName: {
            type: "string",
            description:
              "Name of the type/interface/class to look up",
          },
          code: {
            type: "string",
            description:
