...
export function createArchitectureTools(projectName: string): ToolModule {
  const tools = [
    {
      name: "record_adr",
      ...
      inputSchema: {
        ...
        properties: {
          ...
          example: {
            type: "string",
            description:
              "Example code or file reference demonstrating the pattern",
          },
          appliesTo: {
            type: "string",
            description:
      ...
      inputSchema: {
        ...
        properties: {
          ...
          appliesTo: {
            type: "string",
            description:
              "Filter by what patterns apply to (e.g., 'api', 'module')",
          },
          limit: {
            type: "number",
            description: "Max results (default: 10)",
  ...
  async function handleRecordAdr(
...
${appliesTo ? `## Applies To\n${appliesTo}` : ""}`;
  ...
  async function handleCheckArchitecture(
    args: Record<string, unknown>,
    ctx: ToolContext,
  ): Promise<string> {
...
3. Specific recommendations for improvements`;
  ...
  async function handleSuggestArchitecture(
    args: Record<string, unknown>,
    ctx: ToolContext,
  ): Promise<string> {
  ...
  async function handleRecordTechDebt(
    args: Record<string, unknown>,
    ctx: ToolContext,
  ): Promise<string> {
...
${relatedAdr ? `## Related ADR\n${relatedAdr}` : ""}`;
  ...
  async function handleGetTechDebt(
    args: Record<string, unknown>,
    ctx: ToolContext,
  ): Promise<string> {
  ...
  async function handleAnalyzeProjectStructure(
    args: Record<string, unknown>,
    ctx: ToolContext,
  ): Promise<string> {
